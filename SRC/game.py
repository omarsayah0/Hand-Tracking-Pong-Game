...
imgGameOver = cv2.imread("gameOver3.png")
...
while True:
    ...
    if gameOver:
        img = imgGameOver
        if (score[0] ==5):
            cv2.putText(img, str("left").zfill(2), (585, 360), cv2.FONT_HERSHEY_COMPLEX,
                        2, (200, 160, 80), 3)
        
        if (score[1] ==5):
            cv2.putText(img, str("right").zfill(2), (585, 360), cv2.FONT_HERSHEY_COMPLEX,
                        1.6, (200, 160, 80), 3)
